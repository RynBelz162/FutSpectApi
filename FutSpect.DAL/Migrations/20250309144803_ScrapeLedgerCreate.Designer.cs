...
namespace FutSpect.DAL.Migrations
{
    ...
    [Migration("20250309144803_ScrapeLedgerCreate")]
    partial class ScrapeLedgerCreate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FutSpect.DAL.Entities.Countries.CountryEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FutSpect.DAL.Entities.Scraping.ScrapeTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FutSpect.DAL.Entities.Clubs.ClubEntity", b =>
                {
                    ...
                    b.HasOne("FutSpect.DAL.Entities.Countries.CountryEntity", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("FutSpect.DAL.Entities.Scraping.ScrapeLedgerEntity", b =>
                {
                    b.HasOne("FutSpect.DAL.Entities.Scraping.ScrapeTypeEntity", "ScrapeType")
                        .WithMany()
